...
if [ "$DOCKER_CONTAINER" != $IMAGE_NAME ]; then
    ...
    docker create -it --name $CONTAINER_NAME  -p 18000:1025 -p 18001:1993 -p 18002:8000 -p 18003:1465 -p 18004:1143 -p 18005:1587 -p 18006:37809 -p 18007:1110 mail-server
fi
